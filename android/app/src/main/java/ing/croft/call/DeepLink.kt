 ...
 *
 * [device] and [grant] (contract §5) identify which device was resolved and
 * which grant authorized the call; they are carried so a later call-time
 * re-check (contract §7) can re-validate the grant. Absent for a v1 link.
 */
data class Callee(
